...
import bgImage from "../img/homebg.jpg";
import bgImageUAT from "../img/homebg-2.jpg";
    ...
    return (
      <>
        ...
        {!this.state.toggleDocDepo && !this.state.showOutageTemplate && (
          <>
            <div className="col-12 p-1 search-base display-none">
        ...
        {!this.state.toggleDocDepo && !this.state.showOutageTemplate && (
          <div
            ...
            style={URLConfig.get_Environment() === "UAT" ? mystyleUAT : mystyle}
          >
            {/* bg-imgcss */}
            <div id="topbtns" className="col-12 row pt-1">
              ...
              {this.state.isDeltaUser && (
                <>
                  <div id="sowbtn" title="Solution 360" className="sowbtn">
                    <img
                      ...
                      onClick={() => {
                        ...
                        this.TrackingService.LogSowClick(
                          Cookies.get("empnumber")
                        );

                        this.props.history.push("/sow");
                        // window.location.href = window.location.href + "sow";
                      }}
                    />
                  </div>
                  <FlyerTool right="125px" />
                </>
              )}
              <div className="ml-2 submenubtn_main" id="submenubtn">
                {/* <div id="helptextflash">
                  <img
                    id="floatflash"
                    className="blink_me"
                    src={chatflash}
                ...
                <OverlayTrigger
                  ...
                  overlay={
                    <Tooltip id={`tooltip1`}>
                      {`Click for Practice & Projects View`}
                    </Tooltip>
                  }
                >
                  <i
                    ...
                    id="practiceproham"
                    onClick={() =>
                      this.showHideDivProjects("practiceProjectDic")
                    }
                  />
                </OverlayTrigger>
              </div>
              <div id="practiceProjectDic" className="capsulefiltermain">
                {/* <div className="col-12 pl-0 pr-0" style={{ textAlign: "left" }}>
                  <PracticeDropdown
                    ApplyFilter={this.ApplyFilter}
                    onSubmit={this.onSearchFormSubmit}
                    showHideDiv={this.showHideDiv}
                  />
                </div>
                <div className="col-12 pl-0 pr-0" style={{ textAlign: "left" }}>
                  {some(Roles, (item) =>
                    includes(["Sales", "Pursuit"], item)
                  ) && (
                    <ProjectDropdown
                      setActiveFilterAndValue={this.setActiveFilter}
                      onCustomerSubmit={this.onCustomerSearchFormSubmit}
                  ...
                  <div className="container mt-2 p-0">
                    <div className="accordion" id="RightSideBarAccordion">
                      <div className="card" style={{ textAlign: "left" }}>
                        <div className="card-headerremove" id="exItem1Header">
                          <h5 className="mb-0">
                            <button
                        ...
                        <div
                          ...
                          data-parent="#RightSideBarAccordion"
                        >
                          ...
                          <div className="card-body">
                            {some(Roles, (item) =>
                              ...
                              <ProjectDropdown
                                setActiveFilterAndValue={this.setActiveFilter}
                                onCustomerSubmit={
                                  this.onCustomerSearchFormSubmit
                                }
                                onSubmit={this.onSearchFormSubmit}
                              />
                            )}
                      ...
                      <div className="card" style={{ textAlign: "left" }}>
                        <div className="card-headerremove" id="exItem3Header">
                          <h5 className="mb-0">
                            <button
                              ...
                              onClick={this.logMyContribution}
                            >
                              My Contribution
                            </button>
                          </h5>
                        ...
                        <div
                          ...
                          data-parent="#RightSideBarAccordion"
                        >
                          <div className="card-body ml-3 mb-2">
                            <HeaderCounts />
                          </div>
                        </div>
                      </div>
            ...
            <div className="col-5 pt-2 pb-2 ml-3">
              <div
                id="search-container"
                className="pt-0 pb-4 pl-3 search_container"
              >
                <div className="col-12 mt-0 pl-3">
                  <img
                    className="img-fluid"
                    src={adeltamodel}
                    style={{ width: "350px" }}
              ...
              {this.state.showFeedbackform && (
                <Modal
                  ...
                  onHide={this.showFeedback}
                  dialogClassName="feedbackModal"
                >
                  <Modal.Header>
                    <Modal.Title>
                      <p className="ml-4 pl-2 custom-feedbacktitle">
                  ...
                  <Modal.Body bsPrefix="document-data-modal">
                    <Feedback onFeedbackFormClose={this.onFeedbackFormClose} />
                  </Modal.Body>
                  <Modal.Footer>
                    <button
                      type="button"
            ...
            <div className="col-5 pt-0 pb-0 ml-3">
              <div
                id="search-container"
              ...
              >
                <div className="col-12 mt-0 p-0">
                  <img src={campignimage} alt="" width="100%" height="160" />
                  {/* <CampaignBanner /> */}
                </div>
              </div>
            </div>
            ...
            {/* Feedback Survey marquee starts*/}
                ...
                <div className="mt-2 ml-3">
                  <div className="marquee-main">
                    ...
                    >
                      ...
                      >
                        Knowledge Management Center [DELTA] User Experience
                        Survey is now LIVE!! Hurry up and submit your feedback.
                        We've {this.state.daysleft} more days left to
                        participate
                      </a>
                    </Marquee>
                  </div>
