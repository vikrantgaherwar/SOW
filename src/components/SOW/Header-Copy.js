...
const Header = (props) => {
  ...
  useEffect(() => {
    ...
    if (location.pathname.indexOf("sow") > -1) {
      dispatch1(actionSowHistorySidePanelSearch());
      dispatch1(actionDraftGetAllDrafts());
      dispatch1(actionSolutionHubSidePanelSearch());
      dispatch1(actionGetSOWUserDetails());
    }
